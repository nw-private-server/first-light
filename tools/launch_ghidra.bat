...
echo   2. Project: Open or create "C:\Users\<username>\Programs\NewWorldPrivate\analysis\ghidra_project"
echo   3. File ^> Import File... pick <archive-root>\GameClient\Bin64\NewWorld.exe
