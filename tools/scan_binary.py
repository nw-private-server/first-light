...
Usage:
    ...
    python tools/scan_binary.py --exe H:\SteamLibrary\steamapps\common\New World\Bin64\NewWorld.exe
"""
...
DEFAULT_EXE = Path(r"G:\NewWorldArchive\GameClient\Bin64\NewWorld.exe")
