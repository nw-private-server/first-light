    ...
    return [
        ...
        },
        {
            ...
            "summary": "Static-RE has mapped the post-V3 state-spawn "
                       ...
                       "**writer NOT yet identified statically**, but "
                       "wake 241 surfaced a substantive **alternative "
                       "hypothesis**: the gate may be set by a "
                       "client-side actor-spawn-complete callback "
                       "rather than a server message (the state name "
                       "`WaitingForPlayerSpawn` is suggestive). If "
                       "this hypothesis holds, **MVP server-side "
                       "needs only SelfIdent + LevelInfoChanged** — "
                       "state 13→14 fires from the client's actor "
                       "system once the level data is loaded, no "
                       "additional network message needed. The "
                       "wake-241 investigation log captures candidate "
                       "triage (top tier-A: `FUN_146c60830` at a "
                       "message-handler-adjacent address takes a DIL "
                       "bool param), the 0x145a-namespace scan that "
                       "confirms the writer is NOT in the wrapper-"
                       "setter family, and 5 concrete next-step "
                       "Ghidra actions including a Frida-hook "
                       "fallback. See "
                       ...
                       "for the wake-241 search log. The wake-112 + "
                       "wake-232 individual cards capture the "
                       "breakthroughs; this synthesis card surfaces "
