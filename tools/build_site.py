    ...
    return [
        ...
        },
        {
            ...
            "summary": "Static-RE has mapped the post-V3 state-spawn "
                       ...
                       "**writer identified wake 247**: "
                       "`FUN_142ffbc50` (in the 0x142ff connection-"
                       "namespace, NOT the actor namespace as the "
                       "wake-241 alt hypothesis suggested). The "
                       "function walks a 0x70-stride collection at "
                       "`wrapper[+0x1b8..+0x1c0]`, sets the gate to "
                       "1 if any entry matches `param_2` via two "
                       "predicates (`FUN_1434b0940` then "
                       "`FUN_1434985c0`), and emits a notification "
                       "callback. **5 unconditional-call xrefs** "
                       "from sibling functions in the 0x142ff8-"
                       "0x142ffc range — observer-notify pattern. "
                       "The wake-241 alt hypothesis (\"MVP may only "
                       "need SelfIdent + LevelInfoChanged\") is "
                       "**partly weakened** since the writer is in "
                       "connection-namespace code (not pure-local "
                       "actor code), but the trigger context is "
                       "still TBD — the 5 callers determine whether "
                       "the gate-set is server-message-driven or "
                       "local-event-driven. Next concrete static-RE "
                       "step: decompile the 5 callers. See "
                       ...
                       "for the wake-241 search log + wake-247 "
                       "finding. The wake-112 + wake-232 individual "
                       "cards capture the earlier breakthroughs; "
                       "this synthesis card surfaces the complete "
                       "4-transition picture in one place.",
        },
        {
        ...
        },
        {
            ...
            "summary": "Live-decoder coverage at 36/40 (90.0%) after "
                       ...
                       "either server-only or meta-codecs. Wake 221 "
                       "documented the explicit decision to leave "
                       "0x065c out as well — the 12-kbyte size + "
                       "42-record blob fails the \"single-screen JS "
                       "rendering useful to a visitor\" bar that the "
                       "other 36 covered types meet (see "
                       "`analysis/decision_0x065c_live_decoder.md` "
                       "for the criteria, reversal conditions, and "
                       "the 120-150-line cost estimate that drove "
                       "the call). Reference points for any future "
                       "complex codec: wake 213's 0x0635 shipped at "
                       "~70 lines, wake 217's 0x12f6 at ~85 lines. "
                       "Updated wakes 216, 217, and 221; this card "
                       "now tracks the current count rather than "
                       "the wake-200 snapshot of 6. **90.0% is the "
